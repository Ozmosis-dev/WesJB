      ...
      <section className="bg-canvas border-b border-cream/15 py-[clamp(4rem,10vh,8rem)]">
        <div className={CX.container}>
          <div className="flex flex-col gap-6 max-w-[920px]">
            ...
            {/* Pull-quote */}
            <motion.figure
              className="mt-8 pt-8 border-t-2 border-accent flex flex-col gap-3"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.85, duration: 0.5, ease: SPRING }}
            >
              <blockquote className="flex flex-col gap-1 m-0">
                {["Preparation", "Outperforms", "Talent."].map((word, i) => (
                  <motion.span
                    key={word}
                    className="block font-display font-bold uppercase tracking-[-0.01em] leading-[0.95] text-quote text-cream"
              ...
              <motion.figcaption
                className="font-display font-semibold text-[14px] tracking-[0.18em] uppercase text-accent mt-4"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1.32, duration: 0.4, ease: SPRING }}
              >
                Wesley Johnson · Head Coach
              </motion.figcaption>
            </motion.figure>
          </div>
        </div>
          ...
          >
            {PILLARS.map((p) => (
              ...
              >
                ...
                <h3 className="font-display font-semibold text-[28px] uppercase text-cream m-0">
                  {p.label}
                </h3>
